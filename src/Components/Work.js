...
function Work({ logo, position, company, location, type, duration }) {
  return (
    <article className="flex items-center pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
